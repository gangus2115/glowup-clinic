  ...
  return (
    <div className="relative w-full h-full min-h-[400px] lg:min-h-[600px] flex items-center justify-center overflow-hidden rounded-2xl pointer-events-none">
      ...
      <div className="relative flex items-center justify-center w-full h-full scale-75 md:scale-90 lg:scale-100">
        ...
        {/* KARTA 1: Back layer */}
        <div className="absolute -translate-x-10 -translate-y-12 -rotate-6 w-64 h-24 rounded-3xl backdrop-blur-xl bg-white/[0.03] border border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.1)] flex items-center justify-center z-10">
        ...
        <div className="absolute w-72 h-28 rounded-3xl backdrop-blur-xl bg-white/[0.03] border border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.1),_0_8px_32px_rgba(0,0,0,0.4)] flex items-center justify-center z-20">
