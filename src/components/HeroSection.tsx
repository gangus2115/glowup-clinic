      ...
      <AnimatePresence>
        {showStickyBar && (
          <motion.div 
            ...
            className="md:hidden fixed bottom-0 left-0 right-0 z-30 bg-white/80 backdrop-blur-md border-t border-stone-200/50 shadow-[0_-10px_40px_rgba(0,0,0,0.05)] p-4 flex items-center justify-between"
          >
          ...
          <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-4">
            ...
            {isTyping && (
              <div className="flex w-full justify-start">
                <div className="bg-gradient-to-br from-white/90 to-[#FDFBF7]/90 backdrop-blur-2xl border border-white shadow-sm p-5 rounded-3xl rounded-tl-md max-w-[85%] text-stone-700 font-light leading-relaxed text-sm min-h-[60px] flex items-center">
